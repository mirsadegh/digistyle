                ...
                <div class="col-md-6 col-md-offset-3">
                    <form method="post" action="/administrator/products/{{$product->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="discount_price" value="{{ $product->discount_price }}" class="form-control" placeholder="قیمت  ویژه را وارد کنید...">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="meta_desc" class="form-control" placeholder="توضیحات سئو را وارد کنید...">{{ $product->meta_desc }}</textarea>
                        </div>
                        <div class="form-group">
