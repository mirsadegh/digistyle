<template>
    <div>
        <div class="form-group">
                ...
                <select name="categories[]" class="form-control" multiple="true" v-model="categories_selected" @change="onChange($event,null)">
        ...
        <div v-if="flag">
            <div class="form-group" v-for="(attribute,index) in attributes" >
                ...
                <select  class="form-control" @change="addAttribute($event,index)">
                    ...
                    <option v-if="product" v-for="attributeValue in attribute.attributes_value" :value="attributeValue.id" :selected="product.attribute_values[index].id == attributeValue.id">{{attributeValue.title }}</option>
                </select>
            </div>
        </div>
